...
import { sep, posix, normalize } from 'base/common/path';
import { endsWith, startsWithIgnoreCase, rtrim, startsWith } from 'base/common/strings';
import { Schemas } from 'base/common/network';
import { isLinux, isWindows, isMacintosh } from 'base/common/platform';
import { isEqual, basename, relativePath } from 'base/common/resources';
            ...
            for (let start = segments.length - subpathLength; match && start >= 0; start--) {
                ...
                for (let otherPathIndex = 0; !match && otherPathIndex < paths.length; otherPathIndex++) {
                    ...
                    if (otherPathIndex !== pathIndex && paths[otherPathIndex] && paths[otherPathIndex].indexOf(subpath) > -1) {
                        ...
                        const subpathWithSep = (start > 0 && paths[otherPathIndex].indexOf(sep) > -1) ? sep + subpath : subpath;
                        const isOtherPathEnding = endsWith(paths[otherPathIndex], subpathWithSep);
