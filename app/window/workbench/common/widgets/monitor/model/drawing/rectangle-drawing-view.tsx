...
export class MonitorWidgetRectangleDrawingView
    extends MonitorWidgetDrawingView<RectangleDrawing> 
    implements IMonitorWidgetRectangleDrawingView {

  private readonly mouseMoveMonitor = new InterruptableMouseMoveMonitor();

  constructor(parent: MonitorWidgetSelectableView, timeline: ITimeline, trackItem: ITrackItem, drawing: RectangleDrawing) {
  ...
  render(): React.ReactNode {
    return <MonitorWidgetRectangleDrawingViewComponent view={this}/>
  }
...
@observer
export class MonitorWidgetRectangleDrawingViewComponent extends
    MonitorWidgetDrawingViewComponent<MonitorWidgetRectangleDrawingView> {
  ...
  constructor(props: MonitorWidgetDrawingProps<MonitorWidgetRectangleDrawingView>) {
    super(props);
...
Registry.as<DrawingViewSelectorRegistry>(DrawingViewSelectorRegistry.ID).registerView(RectangleDrawing.TYPE, MonitorWidgetRectangleDrawingView)