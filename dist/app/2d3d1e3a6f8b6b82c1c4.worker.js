...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/ts-loader/index.js!./app/internal/renderer/audio-renderer/worker.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./app/internal/renderer/audio-renderer/all.ts":
/*!*****************************************************!*\
  !*** ./app/internal/renderer/audio-renderer/all.ts ***!
  \*****************************************************/
/*! exports provided: forceImport, TimelineAudioRenderer, AudioTrackItemAudioRenderer, AudioResourceAudioRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "forceImport", function() { return forceImport; });
/* harmony import */ var _timeline_timeline__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timeline/timeline */ "./app/internal/renderer/audio-renderer/timeline/timeline.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimelineAudioRenderer", function() { return _timeline_timeline__WEBPACK_IMPORTED_MODULE_0__["TimelineAudioRenderer"]; });

/* harmony import */ var _timeline_track_item_audio_track_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./timeline/track-item/audio-track-item */ "./app/internal/renderer/audio-renderer/timeline/track-item/audio-track-item.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AudioTrackItemAudioRenderer", function() { return _timeline_track_item_audio_track_item__WEBPACK_IMPORTED_MODULE_1__["AudioTrackItemAudioRenderer"]; });

/* harmony import */ var _resource_audio_resource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./resource/audio-resource */ "./app/internal/renderer/audio-renderer/resource/audio-resource.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AudioResourceAudioRenderer", function() { return _resource_audio_resource__WEBPACK_IMPORTED_MODULE_2__["AudioResourceAudioRenderer"]; });
...
/***/ "./app/internal/renderer/audio-renderer/renderer.ts":
/*!**********************************************************!*\
  !*** ./app/internal/renderer/audio-renderer/renderer.ts ***!
  \**********************************************************/
/*! exports provided: AudioRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AudioRenderer", function() { return AudioRenderer; });
/* harmony import */ var internal_timeline_track_item_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! internal/timeline/track-item-type */ "./app/internal/timeline/track-item-type.ts");
/* harmony import */ var internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! internal/renderer/audio-renderer/common */ "./app/internal/renderer/audio-renderer/common.ts");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! fs */ "fs");
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var base_common_time__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! base/common/time */ "./app/base/common/time.ts");
...
class AudioRenderer {
    ...
    render(timeline, startTime, requestID) {
    ...
    stopRender(requestID) {
        this.currentRequest.requestID = requestID;
        this.currentRequest.play = false;
    }
    startRender(timeline, startTime, startSystemTime, requestID) {
        this.currentRequest.requestID = requestID;
        this.currentRequest.startTime = startTime;
        this.currentRequest.play = true;
        const dt = Object(base_common_time__WEBPACK_IMPORTED_MODULE_3__["getCurrentSystemTime"])() - startSystemTime;
        this._startRender(timeline, startTime + dt);
    }
    _startRender(timeline, startTime) {
        return __awaiter(this, void 0, void 0, function* () {
            let dt = Object(base_common_time__WEBPACK_IMPORTED_MODULE_3__["getCurrentSystemTime"])();
            Atomics.store(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_SIGNAL, 1);
            Atomics.wait(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_SIGNAL, 1);
            const startProducerOffset = Atomics.load(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_SIGNAL_RESPONSE);
            let startedSystemTime = Object(base_common_time__WEBPACK_IMPORTED_MODULE_3__["getCurrentSystemTime"])();
            dt = startedSystemTime - dt;
            startTime += timeline.sequence.videoSetting.frameRate.systemTimeToTime(dt);
            Atomics.sub(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_OFFSET, startProducerOffset);
            ...
            while (true) {
                Atomics.wait(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_OFFSET, this.option.maxSlot);
                // Request guard
                let lastRequestID = Atomics.load(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_REQUEST);
                if (lastRequestID != this.currentRequest.requestID)
                    return;
                yield this.getRenderData(timeline, lastFrameTime, lastFrameTime + this.option.framesPerSlot, tmpFrameBuffer);
                lastRequestID = Atomics.load(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_REQUEST);
                if (lastRequestID != this.currentRequest.requestID)
                    return;
                // Request guard
                const currentProducerOffset = Atomics.load(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_OFFSET);
                if (currentProducerOffset < 0) {
                    const slotsToAdvance = -currentProducerOffset;
                    Atomics.add(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_OFFSET, slotsToAdvance);
                    ...
                    if (Atomics.compareExchange(this.buffers.slotState, recordingSlotOffset, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererSlotState"].IDLE, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererSlotState"].BUSY) == internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererSlotState"].IDLE) {
                        const dataBufferView = new Float32Array(tmpFrameBuffer.buffer, 0, this.option.bytesPerSlot / 4);
                        const slotBufferView = Object(internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["getSlotBufferView"])(this.option, this.buffers.slotData, recordingSlotOffset);
                        ...
                        Atomics.store(this.buffers.slotState, recordingSlotOffset, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererSlotState"].IDLE);
                    }
                    else {
                ...
                Atomics.add(this.buffers.state, internal_renderer_audio_renderer_common__WEBPACK_IMPORTED_MODULE_1__["AudioRendererStateIndex"].PRODUCER_OFFSET, 1);
                this.currentSlotIndex += 1;
                const lastTime = timeline.sequence.audioFrameToTime(lastFrameTime);
                if (!this.currentRequest.play && lastTime - startTime >= 0.1)
                    return;
            }
        });
    }
    getRenderData(timeline, startFrame, endFrame, outBuffer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            timeline.tracks.forEach(track => {
                ...
                trackItems.forEach(trackItem => {
                    if (trackItem.type != internal_timeline_track_item_type__WEBPACK_IMPORTED_MODULE_0__["TrackItemType"].AUDIO)
                        return;
                    const audioTrackItem = trackItem;
    ...
    getTrackItemRenderData(trackItem, startFrame, endFrame) {
        return __awaiter(this, void 0, void 0, function* () {
            const fd = Object(fs__WEBPACK_IMPORTED_MODULE_2__["openSync"])(trackItem.resource.path + '.raw', 'r');
            const buffer = new Float32Array(endFrame - startFrame);
            return new Promise((resolve, reject) => {
                Object(fs__WEBPACK_IMPORTED_MODULE_2__["read"])(fd, buffer, 0, (endFrame - startFrame) * 4, startFrame * 4, (err, bytesRead, buffer) => {
                    if (err)
                        return reject(err);
                    resolve(buffer);
                    Object(fs__WEBPACK_IMPORTED_MODULE_2__["close"])(fd, err => {
                        if (err)
                            console.error(err);
                    });
                });
...
/***/ "./app/internal/renderer/audio-renderer/resource/audio-resource.ts":
/*!*************************************************************************!*\
  !*** ./app/internal/renderer/audio-renderer/resource/audio-resource.ts ***!
  \*************************************************************************/
/*! exports provided: AudioResourceAudioRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AudioResourceAudioRenderer", function() { return AudioResourceAudioRenderer; });
...
/* harmony import */ var internal_renderer_base_resource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! internal/renderer/base/resource */ "./app/internal/renderer/base/resource/index.ts");
...
let AudioResourceAudioRenderer = class AudioResourceAudioRenderer extends internal_renderer_base_resource__WEBPACK_IMPORTED_MODULE_1__["ResourceRenderer"] {
    onPostableInstanceCreated() {
    }
};
AudioResourceAudioRenderer = __decorate([
    Object(worker_postable__WEBPACK_IMPORTED_MODULE_0__["Posted"])('AudioResource')
], AudioResourceAudioRenderer);



/***/ }),

/***/ "./app/internal/renderer/audio-renderer/timeline/timeline.ts":
/*!*******************************************************************!*\
  !*** ./app/internal/renderer/audio-renderer/timeline/timeline.ts ***!
  \*******************************************************************/
/*! exports provided: TimelineAudioRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimelineAudioRenderer", function() { return TimelineAudioRenderer; });
/* harmony import */ var worker_postable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! worker-postable */ "./node_modules/worker-postable/dist/index.js");
/* harmony import */ var internal_renderer_base_timeline_timeline__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! internal/renderer/base/timeline/timeline */ "./app/internal/renderer/base/timeline/timeline.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let TimelineAudioRenderer = class TimelineAudioRenderer extends internal_renderer_base_timeline_timeline__WEBPACK_IMPORTED_MODULE_1__["TimelineRenderer"] {
    constructor() {
        super(...arguments);
        this.paused = true;
    }
    get currentTime() {
        if (this.paused)
            return this.currentTimePausing;
...
TimelineAudioRenderer = __decorate([
...
/***/ "./app/internal/renderer/audio-renderer/timeline/track-item/audio-track-item.ts":
/*!**************************************************************************************!*\
  !*** ./app/internal/renderer/audio-renderer/timeline/track-item/audio-track-item.ts ***!
  \**************************************************************************************/
/*! exports provided: AudioTrackItemAudioRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AudioTrackItemAudioRenderer", function() { return AudioTrackItemAudioRenderer; });
...
let AudioTrackItemAudioRenderer = class AudioTrackItemAudioRenderer extends internal_renderer_base_timeline_track_item__WEBPACK_IMPORTED_MODULE_0__["TrackItemRenderer"] {
};
__decorate([
    worker_postable__WEBPACK_IMPORTED_MODULE_1__["posted"]
], AudioTrackItemAudioRenderer.prototype, "resource", void 0);
__decorate([
    worker_postable__WEBPACK_IMPORTED_MODULE_1__["posted"]
], AudioTrackItemAudioRenderer.prototype, "drawing", void 0);
AudioTrackItemAudioRenderer = __decorate([
    Object(worker_postable__WEBPACK_IMPORTED_MODULE_1__["Posted"])('AudioTrackItemImpl')
], AudioTrackItemAudioRenderer);
...
let PropertyRenderer = class PropertyRenderer {
    constructor() {
        this.keyframeTreeMap = new tstl__WEBPACK_IMPORTED_MODULE_1__["TreeMap"]();
    ...
    observeKeyframes(keyframes) {
        Object(worker_postable__WEBPACK_IMPORTED_MODULE_0__["listen"])(keyframes, change => {
            if (change.type == 'add') {
                ...
                this.keyframeTreeMap.insert(Object(tstl__WEBPACK_IMPORTED_MODULE_1__["make_pair"])(keyframe.timecode, keyframe));
            }
        });
    }
    getInterpolatedPropertyValue(timeoffset) {
        if (!this.animated)
...
/***/ "./app/internal/renderer/base/resource/index.ts":
/*!******************************************************!*\
  !*** ./app/internal/renderer/base/resource/index.ts ***!
  \******************************************************/
/*! exports provided: ResourceRenderer, VideoResourceRenderer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _resource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./resource */ "./app/internal/renderer/base/resource/resource.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ResourceRenderer", function() { return _resource__WEBPACK_IMPORTED_MODULE_0__["ResourceRenderer"]; });

/* harmony import */ var _video_resource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./video-resource */ "./app/internal/renderer/base/resource/video-resource.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "VideoResourceRenderer", function() { return _video_resource__WEBPACK_IMPORTED_MODULE_1__["VideoResourceRenderer"]; });
...
/***/ "./node_modules/ts-loader/index.js!./app/internal/renderer/audio-renderer/worker.ts":
/*!*********************************************************************************!*\
  !*** ./node_modules/ts-loader!./app/internal/renderer/audio-renderer/worker.ts ***!
  \*********************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var internal_renderer_audio_renderer_all__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! internal/renderer/audio-renderer/all */ "./app/internal/renderer/audio-renderer/all.ts");
/* harmony import */ var worker_postable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! worker-postable */ "./node_modules/worker-postable/dist/index.js");
/* harmony import */ var internal_renderer_audio_renderer_renderer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! internal/renderer/audio-renderer/renderer */ "./app/internal/renderer/audio-renderer/renderer.ts");
/* harmony import */ var internal_renderer_audio_renderer_message__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! internal/renderer/audio-renderer/message */ "./app/internal/renderer/audio-renderer/message.ts");

Object(internal_renderer_base_all__WEBPACK_IMPORTED_MODULE_0__["forceImport"])();

Object(internal_renderer_audio_renderer_all__WEBPACK_IMPORTED_MODULE_1__["forceImport"])();



const renderer = new internal_renderer_audio_renderer_renderer__WEBPACK_IMPORTED_MODULE_3__["AudioRenderer"]();
let timelineManager;
self.onmessage = function (e) {
    ...
    switch (data.type) {
        case 'POST':
            Object(worker_postable__WEBPACK_IMPORTED_MODULE_2__["postableMessageHandler"])(data.data);
            break;
        case internal_renderer_audio_renderer_message__WEBPACK_IMPORTED_MODULE_4__["AudioRendererMessageEventType"].INIT:
            msg = data;
            timelineManager = worker_postable__WEBPACK_IMPORTED_MODULE_2__["ObjectStore"].get(msg.timelineManagerID);
            renderer.initialize(msg.data);
            break;
        case internal_renderer_audio_renderer_message__WEBPACK_IMPORTED_MODULE_4__["AudioRendererMessageEventType"].PLAY_RENDER:
            {
                msg = data;
            ...
            break;
        case internal_renderer_audio_renderer_message__WEBPACK_IMPORTED_MODULE_4__["AudioRendererMessageEventType"].PAUSE_RENDER:
            {
                msg = data;
                renderer.stopRender(msg.requestID);
            }
            break;
        case internal_renderer_audio_renderer_message__WEBPACK_IMPORTED_MODULE_4__["AudioRendererMessageEventType"].RENDER:
            {
                msg = data;
                const timeline = timelineManager.getTimeline(msg.timelineID);
...
/***/ "./node_modules/worker-postable/dist/src/base/assert.js":
/*!**************************************************************!*\
  !*** ./node_modules/worker-postable/dist/src/base/assert.js ***!
  \**************************************************************/
/*! exports provided: assert */
...
/* harmony import */ var _base_assert__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base/assert */ "./node_modules/worker-postable/dist/src/base/assert.js");
...
function getObject(id) {
    ...
    Object(_base_assert__WEBPACK_IMPORTED_MODULE_2__["assert"])(obj, 'Object not exists. ' + id);
    return obj;
}
...
var PostableAdministrator = /** @class */ (function () {
    ...
    PostableAdministrator.prototype.removeReaction = function (reaction) {
        Object(_base_assert__WEBPACK_IMPORTED_MODULE_2__["assert"])(this.reactions.has(reaction), '[postable] no reaction exists');
        reaction();
...
function createObject(data) {
    ...
    Object(_base_assert__WEBPACK_IMPORTED_MODULE_2__["assert"])(constructor, "[postable] " + data.constructor + " not exist");
...
function destroyObject(data) {
    Object(_base_assert__WEBPACK_IMPORTED_MODULE_2__["assert"])(ObjectStore.has(data.id), "[postable] Destroy failed. No such object " + data.id);
...
function asPostableObject(target) {
    if (!target.__proto__.hasOwnProperty(POSTABLE_FUNC_POST_CREATED)) {
        Object(_base_assert__WEBPACK_IMPORTED_MODULE_2__["assert"])(null, "[postable] " + target + " is not a Postable object.");
        return null;
    }
...
/******/ });
//# sourceMappingURL=2d3d1e3a6f8b6b82c1c4.worker.js.map