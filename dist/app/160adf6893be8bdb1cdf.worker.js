...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function getObject(id) {
    ...
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(obj, 'Object not exists. ' + id);
    return obj;
}
...
var PostableAdministrator = /** @class */ (function () {
    ...
    PostableAdministrator.prototype.removeReaction = function (reaction) {
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(this.reactions.has(reaction), '[postable] no reaction exists');
        reaction();
...
function createObject(data) {
    ...
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(constructor, "[postable] " + data.constructor + " not exist");
...
function destroyObject(data) {
    !(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(ObjectStore.has(data.id), "[postable] Destroy failed. No such object " + data.id);
...
function asPostableObject(target) {
    if (!target.__proto__.hasOwnProperty(POSTABLE_FUNC_POST_CREATED)) {
        !(function webpackMissingModule() { var e = new Error("Cannot find module 'base/assert'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(null, "[postable] " + target + " is not a Postable object.");
        return null;
    }
...
/******/ });
//# sourceMappingURL=160adf6893be8bdb1cdf.worker.js.map